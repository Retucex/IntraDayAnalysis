namespace IntradayAnalysis.Training
{
	...
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			this.noTouchButton = new System.Windows.Forms.Button();
			...
			this.chart1.Size = new System.Drawing.Size(2164, 1416);
			...
			// goLongButton
			// 
			this.goLongButton.Location = new System.Drawing.Point(18, 18);
			this.goLongButton.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
			this.goLongButton.Name = "goLongButton";
			this.goLongButton.Size = new System.Drawing.Size(112, 35);
			this.goLongButton.TabIndex = 1;
			this.goLongButton.Text = "Go Long";
			this.goLongButton.UseVisualStyleBackColor = true;
			this.goLongButton.Click += new System.EventHandler(this.goLongButton_Click);
			// 
			// shortButton
			// 
			this.shortButton.Location = new System.Drawing.Point(140, 18);
			this.shortButton.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
			this.shortButton.Name = "shortButton";
			this.shortButton.Size = new System.Drawing.Size(112, 35);
			...
			// nextDataButton
			// 
			this.nextDataButton.Location = new System.Drawing.Point(448, 18);
			this.nextDataButton.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
			this.nextDataButton.Name = "nextDataButton";
			this.nextDataButton.Size = new System.Drawing.Size(112, 35);
			...
			// rakeInButton
			// 
			this.rakeInButton.Location = new System.Drawing.Point(568, 18);
			this.rakeInButton.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
			this.rakeInButton.Name = "rakeInButton";
			this.rakeInButton.Size = new System.Drawing.Size(112, 35);
			this.rakeInButton.TabIndex = 4;
			this.rakeInButton.Text = "Rake In";
			this.rakeInButton.UseVisualStyleBackColor = true;
			this.rakeInButton.Click += new System.EventHandler(this.rakeInButton_Click);
			// 
			// newButton
			// 
			this.newButton.Location = new System.Drawing.Point(2053, 18);
			...
			// noTouchButton
			// 
			this.noTouchButton.Location = new System.Drawing.Point(259, 18);
			this.noTouchButton.Name = "noTouchButton";
			this.noTouchButton.Size = new System.Drawing.Size(105, 35);
			this.noTouchButton.TabIndex = 6;
			this.noTouchButton.Text = "Nope";
			this.noTouchButton.UseVisualStyleBackColor = true;
			this.noTouchButton.Click += new System.EventHandler(this.noTouchButton_Click);
			// 
			// Form1
			// 
			...
			this.AutoSize = true;
			this.ClientSize = new System.Drawing.Size(2140, 1357);
			this.Controls.Add(this.noTouchButton);
